...
\begin{flushleft}
  \begin{center}
    {\color{blue} \Large Facultad de Matemática y Computación. Universidad de La Habana. \\
...
% --------------- KEYWORDS
\noindent \textbf{Palabras Clave}: Sistemas de Recomendación (RS), Filtrado Colaborativo (CF), Enfoque Probabilístico, Factorización Matricial, \textit{Naive Bayes Collaborative Filtering} (NBCF), Recomendación para Grupos.
...
Otra tesis doctoral relevante es la titulada 
"Recomendación a grupos de usuarios usando el concepto 
de singularidades"\cite{tesis_recomendacion_grupos}. En este trabajo, se introduce un 
enfoque innovador para realizar recomendaciones a 
grupos de usuarios, considerando las preferencias 
individuales dentro del grupo, pero ajustando las 
recomendaciones para maximizar la satisfacción 
colectiva. Este tipo de investigación es crucial 
para la expansión del algoritmo NBCF, que se centra 
en recomendaciones individuales, hacia escenarios 
donde las recomendaciones deben adaptarse a un 
colectivo de usuarios con preferencias diversas.
...
como la factorización matricial \cite{tesis_recomendacion_grupos}.
...
\begin{thebibliography}{}
    ...
    \bibitem{tesis_recomendacion_grupos}
    Ortiz, R. H. (2020). Recomendación a grupos de usuarios usando el concepto de singularidades. (Doctoral dissertation, Universidad Politécnica de Madrid).
