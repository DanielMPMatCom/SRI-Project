...
\begin{figure}[h]
    ...
    \caption{Gráfico de diferencias entre las recomendaciones del sistema y las preferencias reales del usuario.}
...
\begin{figure}[h]
    ...
    \caption{Gráfico de diferencias absolutas entre las recomendaciones del sistema y las preferencias del usuario.}
    \label{fig:absolutas}
\end{figure}
...
Finalmente, se presenta en la Tabla \ref{tab:resultados} 
...
\begin{figure}[h]
    ...
    \caption{Resumen cuantitativo de los resultados del sistema de recomendación.}
